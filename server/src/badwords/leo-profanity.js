...
if (typeof module !== 'undefined' && module.exports != null) {
  ...
  /** @type {Array.string} */
  // LeoProfanity.words = JSON.parse(
  //   JSON.stringify(
  //     LeoProfanity.wordDictionary ? LeoProfanity.wordDictionary['en'] : [],
  //   ),
  // )
  const { baseList, localList } = require('./data.json')
  LeoProfanity.words = [...baseList, ...localList]
